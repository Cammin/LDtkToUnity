...
- Significantly improved support for separate level files
  - Only changed level files are now reimported instead of a project and all it's levels, resulting in significantly faster iteration speeds
...
- Minimum supported Unity version raised to 2020.1 (From 2019.3)
  - The version had to be raised due to new APIs being used for the improved level loading
