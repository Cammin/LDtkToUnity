...
namespace LDtkUnity.Editor
{
    public class LDtkSectionGridPrefabs : LDtkSectionDrawer<LayerDefinition>
    {
        ...
        protected override Texture GuiImage => LDtkIconUtility.GetUnityIcon("Grid");

        public LDtkSectionGridPrefabs(SerializedObject serializedObject) : base(serializedObject)
        {
