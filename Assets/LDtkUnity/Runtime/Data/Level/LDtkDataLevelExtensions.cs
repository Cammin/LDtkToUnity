...
namespace LDtkUnity.Data
{
    public static class LDtkDataLevelExtensions
    {
        ...
        public static Vector2 GetOriginAdjustedWorldCoord(this LDtkDataLevel data, int pixelsPerUnit)
        {
            Vector2 position = LDtkToolOriginCoordConverter.ConvertPixelToWorldPosition(data.WorldCoord(), data.pxHei, pixelsPerUnit);
            Debug.Log(data.WorldCoord());
            return position;
        }
    }
}
