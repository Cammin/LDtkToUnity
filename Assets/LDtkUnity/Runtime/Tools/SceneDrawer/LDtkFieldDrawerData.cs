...
namespace LDtkUnity
{
    ...
    public class LDtkFieldDrawerData : LDtkSceneDrawerBase
    {
        ...
        public LDtkFieldDrawerData(LDtkFields fields, Color color, EditorDisplayMode fieldMode, string identifier, int gridSize, Texture iconTex, Rect iconRect, Vector3 middleCenter) : base(identifier, color)
        {
            _fields = fields;
